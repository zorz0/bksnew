    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contetnt') ? 'is-invalid' : '' }}" type="text" name="contetnt" id="contetnt" value="{{ old('contetnt', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo') ? 'is-invalid' : '' }}" type="text" name="seo" id="seo" value="{{ old('seo', '') }}" required>
                @if($errors->has('seo'))
