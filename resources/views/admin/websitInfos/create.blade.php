...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.websit-infos.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook_link') ? 'is-invalid' : '' }}" type="text" name="facebook_link" id="facebook_link" value="{{ old('facebook_link', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('insta_link') ? 'is-invalid' : '' }}" type="text" name="insta_link" id="insta_link" value="{{ old('insta_link', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('who_us') ? 'is-invalid' : '' }}" type="text" name="who_us" id="who_us" value="{{ old('who_us', '') }}" required>
