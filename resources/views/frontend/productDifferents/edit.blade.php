    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.product-differents.update", [$productDifferent->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="product_difference">{{ trans('cruds.productDifferent.fields.product_difference') }}</label>
                            <input class="form-control" type="text" name="product_difference" id="product_difference" value="{{ old('product_difference', $productDifferent->product_difference) }}" required>
