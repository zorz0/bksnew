    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.websit-infos.update", [$websitInfo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="phone_number">{{ trans('cruds.websitInfo.fields.phone_number') }}</label>
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $websitInfo->phone_number) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook_link" id="facebook_link" value="{{ old('facebook_link', $websitInfo->facebook_link) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="insta_link" id="insta_link" value="{{ old('insta_link', $websitInfo->insta_link) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="youtube_link" id="youtube_link" value="{{ old('youtube_link', $websitInfo->youtube_link) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="who_us" id="who_us" value="{{ old('who_us', $websitInfo->who_us) }}" required>
