                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.posts.update", [$post->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contetnt" id="contetnt" value="{{ old('contetnt', $post->contetnt) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="seo" id="seo" value="{{ old('seo', $post->seo) }}" required>
                            @if($errors->has('seo'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('seo') }}
                                </div>
