...
@section('content')
    ...
    <section class="u-clearfix u-section-1">
        <div class="container">
            <div class="u-khayba-phone col-md-12" style="background-image: url({{ asset('images/phone.png')}})">
        ...
        <div class="container pt-5">
            <div class="u-khayba-email col-md-12" style="background-image: url({{ asset('images/email.png')}})">
        ...
        <div class="row">
            <div class="container mt-5 mb-5" style="height: 500px;">
                <div class="u-khayba-location col-md-12" style="background-image: url({{ asset('images/location.png')}})">
                    <p class="pt-5 pl-5 text-left" style="font-size: 14px;">
                        جرش / سوف / منطقة البرج
                    </p>
                    <p class="location">
