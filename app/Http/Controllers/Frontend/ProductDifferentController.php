...
class ProductDifferentController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.productDifferents.index', compact('productDifferents'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.productDifferents.create');
    }
    ...
    public function store(StoreProductDifferentRequest $request)
    {
        ...
        return redirect()->route('frontend.product-differents.index');
    }
    ...
    public function edit(ProductDifferent $productDifferent)
    {
        ...
        return view('frontend.productDifferents.edit', compact('productDifferent'));
    }
    ...
    public function show(ProductDifferent $productDifferent)
    {
        ...
        return view('frontend.productDifferents.show', compact('productDifferent'));
    }
