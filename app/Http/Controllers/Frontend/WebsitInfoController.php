...
class WebsitInfoController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.websitInfos.index', compact('websitInfos'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.websitInfos.create');
    }
    ...
    public function store(StoreWebsitInfoRequest $request)
    {
        ...
        return redirect()->route('frontend.websit-infos.index');
    }
    ...
    public function edit(WebsitInfo $websitInfo)
    {
        ...
        return view('frontend.websitInfos.edit', compact('websitInfo'));
    }
    ...
    public function show(WebsitInfo $websitInfo)
    {
        ...
        return view('frontend.websitInfos.show', compact('websitInfo'));
    }
